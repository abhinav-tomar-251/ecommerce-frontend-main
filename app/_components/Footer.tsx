...
import {FaArrowUp , FaApplePay, FaCcMastercard, FaCcPaypal, FaCcVisa, FaFacebookF, FaGithub, FaGooglePay, FaInstagram, FaTwitter } from "react-icons/fa"
...
const Footer = () => {
  ...
  return (
    <footer className="bg-footer_color flex flex-col mt-28 pb-12">
       {showButton && (
        <button className="fixed bottom-4 right-4 bg-gray-900 text-white rounded-full p-2 shadow-md" onClick={scrollToTop}>
          <FaArrowUp />
        </button>
      )}
        ...
        <div className="relative flex mx-32  items-center">
             <div className="flex-grow border-t border-gray-400"></div>
        </div>

        <div className="flex flex-row justify-between items-center mx-48 py-2">
            <p className="text-slate-500 font-normal ">© 2000-2024, All rights reserved</p>

...
const UploadProduct: React.FC<UploadProductProps> = ({ onClose, fetchData }) => {
  ...
  const handleUploadProduct = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const fileInput = document.getElementById('uploadImageInput') as HTMLInputElement;
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (responseData.success) {
        ...
        toast.error(responseData.message || 'Failed to upload product. Please try again.');
      }
    } catch (error) {

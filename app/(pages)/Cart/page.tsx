                ...
                <div key={product?._id} className='w-full bg-white h-32 my-2 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                  ...
                  <div className='px-4 py-2 relative'>
                    ...
                    <div className='flex items-center gap-3 mt-1'>
                      <button className='border border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-white w-6 h-6 flex justify-center items-center rounded ' onClick={() => decreaseQty(product?._id, product?.quantity)}>-</button>
            ...
            <div className='mt-5 lg:mt-0 w-full max-w-sm'>
          {
            loading ? (
              ...
              <div className='h-36 bg-white rounded-md shadow-md px-2'>
                <h2 className='text-white bg-gray-600 px-4 py-1 rounded-sm'>Cart Summary</h2>
                ...
                <button onClick={handlePayment} className='bg-gray-800 p-2 text-white w-full rounded-md mt-2 hover:bg-gray-500'>Checkout</button>
              </div>
            )
          }
        </div>

                ...
                <div className='bg-slate-400 rounded-lg shadow-lg item-content p-5 w-full max-w-md mx-auto'>
                        ...
                        <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit} >
                            ...
                            <div className='grid gap-2'>
                                ...
                                <Link href={'/auth/ForgotPassword'} className='block w-fit ml-auto hover:underline hover:text-red-600'>
                                    Forgot password ?
                                </Link>
                            </div>

                            <button className='bg-slate-600 hover:bg-slate-700 text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6'>Login</button>

                        </form>

                        <p className='my-5'>Not have an account ? <Link href={"/auth/Register"} className=' text-slate-800 hover:text-slate-700 hover:underline'>Sign up</Link></p>
                </div>

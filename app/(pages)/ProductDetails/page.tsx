...
const ProductDetails: React.FC = () => {
  ...
  const [zoomImageCoordinate, setZoomImageCoordinate] = useState<{ x: number; y: number }>({
    x: 0,
    y: 0
  });
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
          <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
            ...
            {/* Product Zoom */}
            {zoomImage && (
              <div className='h_idden lg:block absolute min-w-[500px] overflow-h_idden min-h-[400px] bg-slate-200 p-1 -right-[510px] top-0'>
                <div
        ...
        {/* Product Details */}
        {loading ? (
          <div className='gr_id gap-1 w-full'>
